...
const ChatArea = React.memo(function ChatArea({
  ...
  return (
    <div className={`chat-area ${dragOver ? 'drag-over' : ''}`}
      ...
      {showPinnedPanel && (
        <div className="mobile-pinned-panel" style={{ position: 'absolute', top: 0, right: 0, width: '340px', height: '100%', background: '#2b2d31', borderLeft: '1px solid #3a3a3e', zIndex: 100, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {showThreadsListPanel && (
        <div className="mobile-thread-list-panel" style={{ position: 'absolute', top: 0, right: 0, width: '340px', height: '100%', background: '#2b2d31', borderLeft: '1px solid #3a3a3e', zIndex: 100, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          <div style={{ padding: '16px', borderBottom: '1px solid #3a3a3e', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      {showSearchPanel && (
        <div className="mobile-search-panel" style={{ position: 'absolute', top: 0, right: 0, width: '340px', height: '100%', background: '#2b2d31', borderLeft: '1px solid #3a3a3e', zIndex: 100, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
